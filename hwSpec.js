...
describe("largest", function () {
    it("should return 2 when we pass [2,4,5,10] as an argument", function () {
        expect(largest([2,4,5,10])).toEqual(2);
    });
    it("should return -10 when we pass returnLargest([-10,0,15])", function () {
        expect(largest([-10,0,15])).toEqual(-10);
    })
    it("should return 1 when we pass returnLargest([1,4,8,52])", function () {
        expect(largest([1,4,8,52])).toEqual(1);
    })
});